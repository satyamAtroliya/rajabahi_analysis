...
public class Strategy40x implements Strategy {

    private static final double TRIGGER = 40.0;

    // After a 20x+ trigger:
    private static final int WAIT_ROUNDS = 65;
    private static final int BET_ROUNDS = 4;
