...
public class Strategy20x implements Strategy {

    private static final double TRIGGER = 20.0;

    // After a 20x+ trigger:
    private static final int WAIT_ROUNDS = 67;
    private static final int BET_ROUNDS = 21;
